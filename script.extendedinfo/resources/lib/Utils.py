...
OPENMETA_TV_FOLDER = xbmcaddon.Addon('plugin.video.discover').getSetting('tv_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.discover)') else None
OPENMETA_MOVIE_FOLDER = xbmcaddon.Addon('plugin.video.discover').getSetting('movies_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.discover)') else None
