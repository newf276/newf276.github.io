...
def getMovieMeta(id_type, media_id, user_info, hours=720):
	...
	if not meta:
		try:
			...
			meta = buildMovieMeta(tmdb_data, fanarttv_data=fanarttv_data)
			set_cache_meta()
		except: pass
	return meta
...
def getTVShowMeta(id_type, media_id, user_info, hours=96):
	...
	if not meta:
		try:
			...
			meta = buildTVShowMeta(tmdb_data, fanarttv_data=fanarttv_data, tvdb_summary=tvdb_summary)
			set_cache_meta()
		except: pass
	return meta
...
def buildMovieMeta(data, fanarttv_data=None):
	meta = {}
	writer = []
	meta['cast'] = []
	meta['studio'] = []
	...
	if data.get('poster_path'):
		...
		meta['poster'] = xbmc.translatePath('special://home/addons/script.module.tikimeta/resources/default_images/tikimeta_blank_poster.png')
	if data.get('backdrop_path'):
		...
		meta['fanart'] = xbmc.translatePath('special://home/addons/script.module.tikimeta/resources/default_images/tikimeta_blank_fanart.png')
	if fanarttv_data:
		...
		meta['banner'] = xbmc.translatePath('special://home/addons/script.module.tikimeta/resources/default_images/tikimeta_blank_banner.png')
		meta['clearart'] = ''
		meta['clearlogo'] = ''
		meta['landscape'] = ''
		meta['discart'] = ''
...
def buildTVShowMeta(data, fanarttv_data=None, tvdb_summary=None):
	meta = {}
	writer = []
	creator = []
	meta['cast'] = []
