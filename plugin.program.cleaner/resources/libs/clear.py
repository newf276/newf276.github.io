...
def get_cache_size():
    ...
    dbfiles = [
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'cache.meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'cache.providers.13.db')),
    ...
    if CONFIG.INCLUDEVIDEO == 'true':
        ...
        if CONFIG.INCLUDEALL == 'true':
            ...
            if CONFIG.INCLUDEpenguin == 'true':
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'cache.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'meta.5.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'providers.13.db'))
...
def clear_cache(over=None):
    ...
    dbfiles = [
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thecrew', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.numbersbynumbers', 'cache.db')),
...
def toggle_cache(state):
    cachelist = ['includevideo', 'includeall', 'includeexodusredux', 'includegaia', 'includenumbers', 'includescrubs', 'includeseren', 'includethecrew', 'includepenguin']
    titlelist = ['Include Video Addons', 'Include All Addons', 'Include Exodus Redux', 'Include Gaia', 'Include NuMb3r5', 'Include Scrubs v2', 'Include Seren', 'Include THE CREW', 'Include penguin']
