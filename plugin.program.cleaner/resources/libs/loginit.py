...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-seren', 'fanart-thecrew', 'fanart-finder',
         'fanart-penguin',
         'furk-fen',
         'imdb-exodusredux', 'imdb-gaia', 'imdb-numbers', 'imdb-premiumizer',
         'imdb-realizer', 'imdb-scrubs', 'imdb-thecrew', 'imdb-penguin',
         'kitsu-wonderfulsubs',
         'login-iagl', 'login-netflix',
         'mal-wonderfulsubs',
         'omdb-metadatautils', 'omdb-metahandler', 'omdb-finder',
         ...
         'tmdb-scrubs', 'tmdb-seren', 'tmdb-thecrew', 'tmdb-finder',
         'tmdb-penguin',
...
LOGINID = {
    ...
    'imdb-exodusredux': {
        ...
        'activate' : ''},
    'fanart-penguin': {
        'name'     : 'Fanart.tv - penguin',
        'plugin'   : 'plugin.video.penguin',
        'saved'    : 'fanart-penguin',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'penguin_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'settings.xml'),
        'default'  : 'fanart.tv.user',
        'data'     : ['fanart.tv.user'],
        'activate' : ''},
    'tmdb-penguin': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'penguin_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-penguin': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.penguin', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'penguin_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.penguin', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    ...
    'tmdb-finder': {
        ...
        'plugin'   : 'plugin.video.finder',
        'saved'    : 'tmdb-finder',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.finder'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.finder', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.finder', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'finder_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.finder', 'settings.xml'),
        'default'  : 'tmdb_apikey',
        'data'     : ['tmdb_apikey'],
        'activate' : ''},
    'omdb-finder': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.finder', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.finder', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'finder_omdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.finder', 'settings.xml'),
        'default'  : 'omdb_apikey',
        'data'     : ['omdb_apikey'],
        'activate' : ''},
    'fanart-finder': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.finder', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.finder', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'finder_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.finder', 'settings.xml'),
