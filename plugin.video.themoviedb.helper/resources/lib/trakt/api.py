...
class _TraktLists():
    ...
    @is_authorized
    def get_mixed_list(self, path, trakt_types=[], limit=60, extended=None, authorize=False):
    ...
    @is_authorized
    def get_basic_list(self, path, trakt_type, page=1, limit=60, params=None, sort_by=None, sort_how=None, extended=None, authorize=False, randomise=False):
    ...
    def get_custom_list(self, list_slug, user_slug=None, page=1, limit=60, params=None, authorize=False, sort_by=None, sort_how=None, extended=None):
    ...
    def get_sync_list(self, sync_type, trakt_type, page=1, limit=60, params=None, sort_by=None, sort_how=None, next_page=True):
