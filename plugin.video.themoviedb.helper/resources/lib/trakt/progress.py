...
class _TraktProgress():
    @is_authorized
    def get_inprogress_shows_list(self, page=1, limit=60, params=None, next_page=True, sort_by=None, sort_how=None):
    ...
    def get_calendar_episodes_list(self, startdate=0, days=1, user=True, kodi_db=None, page=1, limit=60):
